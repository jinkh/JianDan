...
CGFloat const JTSImageViewController_DefaultBackgroundBlurRadius = 3.0f;
...
- (void)viewDidLoadForImageMode {
    ...
    self.imageView = [[FLAnimatedImageView alloc] initWithFrame:referenceFrameInMyView];
...
- (UIView *)blurredSnapshotFromParentmostViewController:(UIViewController *)viewController {
    ...
    FLAnimatedImageView *imageView = [[FLAnimatedImageView alloc] initWithFrame:contextBounds];
