...
- (void)handleControllerPop:(UIPanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (progress > 0.4 || velocity.x > 900) {
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if (operation == UINavigationControllerOperationPop) {
        return [[ZHPopAnimation alloc] init];
    } else if (operation == UINavigationControllerOperationPush) {
        return [[ZHPushAnimation alloc] init];
    }
    return nil;
}
...
- (id<UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController
     ...
     */
    if ([animationController isKindOfClass:[ZHPopAnimation class]] || [animationController isKindOfClass:[ZHPushAnimation class]]) {
